  ...
  public: {
    Tables: {
      ...
      group_bookings: {
        Row: {
          ...
          id: string
          is_village_takeover: boolean | null
          name: string
          notes: string | null
          payment_notes: string | null
          shared_dining: boolean | null
          shared_itinerary: Json | null
          single_invoice: boolean | null
      ...
      order_logs: {
        Row: {
          ...
          notes: string | null
          order_category:
            | Database["public"]["Enums"]["order_category_type"]
            | null
          order_date: string
      ...
      vendors: {
        Row: {
          ...
          specialty: Database["public"]["Enums"]["vendor_specialty"]
      ...
      villa_bookings: {
        Row: {
          ...
          cloudbeds_synced_at: string | null
          created_at: string | null
          deposit_amount: number | null
    ...
    Enums: {
      ...
      occasion_type:
        ...
        | "celebration"
        | "other"
      order_category_type: "guest" | "staff" | "waste" | "comp"
